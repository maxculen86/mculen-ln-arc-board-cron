...
import GetCajaCollection from '../../../../components/private/LN/api/v1/global/home/chains/getCajacollection';
...
describe('components - chains - Ln_Caja_Collection - json', () => {
    ...
    test('Test props into class', () => {
        ...
        expect(Object.keys(CajaCollection).sort()).toEqual(
            ['getFieldsInArticleByTypeChain','getQueryElement', 'props', 'state','typeChain'].sort()
        );
    });
