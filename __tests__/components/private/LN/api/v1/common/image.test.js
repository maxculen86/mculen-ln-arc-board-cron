...
describe('Json imagen common', () => {
    ...
    test('Imagen con resize v2', () => {
        ...
        expect(resp.parametros[1].media).toBe(1024);
        ...
        expect(resp.parametros[2].media).toBe(768);
        ...
        expect(resp.parametros[3].media).toBe(768);
        ...
        expect(resp.parametros[4].media).toBe(375);
        ...
        expect(resp.parametros[5].media).toBe(375);
