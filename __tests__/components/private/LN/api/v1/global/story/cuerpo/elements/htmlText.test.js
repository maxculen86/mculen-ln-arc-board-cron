...
describe('Test for html render inside text component', () => {
    test('Render base text', () => {
        ...
        expect(resp[13]).toBe(
            ' Arc tambien puede enviar codigos html tales como proceso & pero no proceso &euro;'
        );
