...
describe('Test de json de imagen en el cuerpo de la nota', () => {
    ...
    it('Valores del json de imagen', () => {
        ...
        expect(resp['url']).toBe(
            'https://resizer.glanacion.com/resizer/vMR5levzUGXFrT4MCNJRoaktaiY=/1920x1280/smart/filters:format(webp):quality(70)/cloudfront-us-east-1.images.arcpublishing.com/sandbox.lanacionar/P4TDYRBWDNB3LCHDELX42HRWAU.jpg?width=512&height=341&quality=90&smart=true'
        );
