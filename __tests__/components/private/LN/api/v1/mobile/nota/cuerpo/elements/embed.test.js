...
import Embed from '../../../../../../../../../../components/private/LN/api/v1/mobile/story/cuerpo/elements/embed';
...
describe('Test de las embebidos en el cuerpo de una nota', () => {
    ...
    it('Valores de embebidos Youtube', () => {
        ...
        expect(resp['id']).toBe(ArticleEmbed[1].subtype);
    ...
    it('Valores de embebidos Vimeo', () => {
        ...
        expect(resp['id']).toBe(ArticleEmbed[2].subtype);
        expect(resp['src']).toBe(
    ...
    it('Valores de embebidos Dailymotion', () => {
        ...
        expect(resp['id']).toBe(ArticleEmbed[3].subtype);
        expect(resp['src']).toBe(
    ...
    it('Valores de embebidos Spotify', () => {
        ...
        expect(resp['id']).toBe(ArticleEmbed[7].subtype);
        expect(resp['src']).toBe(
