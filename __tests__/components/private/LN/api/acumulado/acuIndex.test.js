...
describe('Test de index en Json acumulado', () => {
    ...
    test('Test render', () => {
        ...
        expect(resp.configuracion.headerClass).toBe(dataMock.configuration.header_class_name);
        expect(resp.configuracion.backgroundColor).toBe(dataMock.configuration.background_color);
        expect(resp.configuracion.navigationColor).toBe(dataMock.configuration.navigation_color);
        expect(resp.configuracion.colorTags).toBe(dataMock.configuration.navigation_color_tags);
        expect(resp.configuracion.imagen).toBe(dataMock.configuration.id_logo_image);
    });
