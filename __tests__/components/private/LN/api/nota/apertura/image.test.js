...
describe('Json de Imagen en Nota', () => {
    ...
    it('Valores de la imagen', () => {
        ...
        expect(resp['baseUrl']).toBe('/resizer/{{param}}/cloudfront-us-east-1.images.arcpublishing.com/sandbox.lanacionar/QZO4UCHCSJHWJLQBALT2PGR2EY.jpg');

        expect(resp['parametros'][0]['ancho']).toBe(1260);
        expect(resp['parametros'][0]['firma']).toBe('ll9UIKBF1TEj9aV7Fvgnp39l3KM=/1260x840/smart');
