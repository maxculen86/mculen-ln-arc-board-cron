import { respChildrens } from '../../../../../../../../../../../components/private/LN/api/global/components/chains/common/respChildrens/chainsTypes/apertura';
...
describe('respChildrens apertura', () => {
    ...
    it('if validateChildrens Api of children in props is true, I call setSlicedChildren with the corresponding array', () => {
        ...
        const calledObject = {
            children: props.children, // or children.filter(c => c != null),
            config: { layout: props.customFields.layout, countTimeline: true }
        };
        const result = respChildrens(props);
