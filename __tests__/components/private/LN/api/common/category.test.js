...
import { getSubCategory, getPrincipalCategory } from '../../../../../../components/private/LN/api/v1/common/category';
import articleItem from '../../../../../../components/private/LN/api/v1/acumulado/article';
import { getCategory, isMigratedCategory } from '../../../../../../components/private/common/utils/migratedCategoriesHelper';
...
describe('Test de JSON de tags en article', () => {
    ...
    it('Test para validar si categoria enviada a IsMigratedCategory existe', () => {
        ...
        try {
            ...
            expect(err.message).toBe(`La categoria '/categoria-inexistente' no existe en el diccionario`);
        }
    });
