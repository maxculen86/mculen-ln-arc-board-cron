...
jest.mock('../../../../../../../components/private/LN/home/common/components/storiesBox',
() => 'mocked-component')
...
describe('private - LN - home - common - containers - storiesBox', () => {
    ...
    const container = mount(<StoriesBox articles={articlesCf} >{child}</StoriesBox>)
    ...
    it('Testeo que la cantidad de children pasados al subcomponente correspondan', () => {
        TestHelper.expectSameValue(component.prop('children').length, ARTICLES_COUNT)
    })
})
