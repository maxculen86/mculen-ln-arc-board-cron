jest.mock(
    '../../../../../../../components/private/LN/home/common/components/articleTitle',
    () => 'mocked-title'
);

jest.mock(
    '../../../../../../../components/private/LN/home/common/components/articleTag',
    () => 'mocked-tag'
);

jest.mock(
    '../../../../../../../components/private/LN/home/common/components/articleSubheader',
    () => 'mocked-subheader'
);
...
describe('private - LN - home - common - components - article', () => {
    const imgUrls = [
        {
            name: 'desktop',
            url:
                'http://resizer.shared.arcpublishing.com/waT0eaOu9z7W7IYRMEMgR-ikEUI=/arc-anglerfish-arc2-sandbox-sandbox-lanacionar/public/YQPFIZTCKVFKFDHNINT7IBBI6U.jpg'
        },
        {
            name: 'desktopSM',
            url:
    ...
    const a = {
        ...
        imgUrls: imgUrls,
        url:
            '/2018/09/20/tras-el-0-0-con-independiente-como-le-fue-a-river-en-la-era-marcelo-gallardo-cuando-tuvo-que-definir-una-serie-como-local/',
    ...
    const component = mount(
        <RegularArticleComponent {...a}>{child}</RegularArticleComponent>
    );
