...
describe('Private - Common - Banners - bannerRules', () => {
    it('should test getStickyBanner with megatop banner and cabezal', () => {
        expect(
            ...
            `const banners = Array.from(document.querySelectorAll('.ln-banner-container.--megatop_dsk.--megatop')) || [];`
        );
    });
    it('should test getStickyBanner with cabezal', () => {
        expect(
            ...
            `const banners = Array.from(document.querySelectorAll('.--cabezal_dsk')) || [];`
        );
    });
});
