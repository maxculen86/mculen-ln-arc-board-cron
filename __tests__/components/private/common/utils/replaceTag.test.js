            ...
            items: [
                {
                    type: 'text',
                    content:
                        'Este una lista con un <a href="//www.google.com" target=_blank TERCERA="">link</a>'
                },
                {
                    type: 'text',
                    content:
                        'Otro <a href="//www.google.com" target=_blank TERCERA="">enlace</a> '
                }
            ]
        },
        {
            type: 'text',
            content:
                'Este es un parrafo con un <a href="//www.google.com" target=_blank TERCERA="">link</a> en el medio'
        },
        {
            type: 'raw_html',
            content:
