...
import Toasts from '../../../../../../components/features/LN-10-global/common/toasts/default';
...
describe('Toasts Component', () => {
    ...
    it('should render the toast container with correct props', () => {
        ...
        expect(toastContainer).toHaveAttribute('data-duration', '2750');
        expect(toastContainer).toHaveAttribute('data-h-position', 'end');
        expect(toastContainer).toHaveClass('bottom-64 bottom-100_md');
        expect(toastContainer).toHaveStyle({ alignItems: 'center' });
    });
