import {
    ...
    getCardConfig,
    getChainConfig,
    isBnPlayerDiagramation,
    reorderArticlePositionForVideo,
    updatesTitleTag
...
describe('Components - features - LN-10 - articulo - common - _helper-WebApi', () => {
    describe('getChainConfig', () => {
        describe('Tests in ACUMULADOS', () => {
            ...
            it('should return config the second box, when the first box is hidden', () => {
                expect(
                    getChainConfig({
        ...
        describe('Tests in HOME LN10', () => {
            ...
            it('should return the manual box configuration with box position 01, when the bomb and opening are hidden. ', () => {
                expect(
                    getChainConfig({
            ...
            it('should return the manual box configuration with box position 02, when the bomb are hidden but the opening is visibeld', () => {
                expect(
                    getChainConfig({
                        featureId: 'id-children-caja-manual-ln10',
                        renderables: getRenderables({
            ...
            it('should return the opening box configuration with boxPosition 01, when the bomb are hidden', () => {
                expect(
                    getChainConfig({
    ...
    describe('getCardConfig', () => {
        ...
        it('getCardConfig titleTag should be H1 for the first bomba', () => {
        ...
        it('getCardConfig titleTag shouldnt be H1 if the bomba is not the first one in the chain', () => {
        ...
        it('getCardConfig titleTag shouldnt be H1 if the chain is not the first bomba', () => {
        ...
        it('getCardConfig deleteExtraH1 shouldnt be called with no bomba', () => {
    ...
    describe('updatesTitleTag', () => {
        it('Should return undefined with no cardConfig', () => {
            const result = updatesTitleTag();
            expect(result).toBe(undefined);
        });

        it('Should keep cardConfig unchanged if no updates are required', () => {
        ...
        it('Should update titleTag and subheadTag if articlePosition is 0 and titleTag is not h1', () => {
    ...
    describe('deleteExtraH1', () => {
        ...
        it('should update titleTag to h2 and subheadTag to h3 if titleTag is h1', () => {
            const articlePosition = 0;
            const cardConfig = [
        ...
        it('should not update titleTag and subheadTag if titleTag is not h1', () => {
            const articlePosition = 1;
            const cardConfig = [
                { titleTag: 'h2', subheadTag: 'subhead' },
    ...
    describe('isBnPlayerDiagramation', () => {
        it('should return true if layout is bn_player_3_grid', () => {
            const config = {
                props: {
                    customFields: {
        ...
        it('should return true if layout is bn_player_4_grid', () => {
            const config = {
                props: {
                    customFields: {
        ...
        it('should return false if layout is not valid', () => {
            const config = {
                props: {
                    customFields: {
                        layout: 'bn_1_1_grid'
        ...
        it('should return false if props or customFields are missing', () => {
            expect(isBnPlayerDiagramation({})).toBe(false);
            expect(isBnPlayerDiagramation(null)).toBe(false);
            expect(isBnPlayerDiagramation(undefined)).toBe(false);
        });
    });

    describe('reorderArticlePositionForVideo', () => {
        it('should return the same config if layout is not bn_player_3_grid or bn_player_4_grid', () => {
            const config = {
                props: {
                    customFields: {
                        layout: 'bn_1_1_grid'
        ...
        it('should reorder children to place videoPlayer first when layout is bn_player_3_grid', () => {
            const config = {
                props: {
                    customFields: {
                        layout: 'bn_player_3_grid'
            ...
            const result = reorderArticlePositionForVideo(config);
            expect(result.children[0].type).toBe('LN-10/videoPlayer');
            expect(result.children.map(c => c.id)).toEqual(['2', '1', '3']);
        });

        it('should reorder children to place multiple videoPlayers at the start in order of appearance', () => {
            const config = {
                props: {
                    customFields: {
                        layout: 'bn_player_4_grid'
