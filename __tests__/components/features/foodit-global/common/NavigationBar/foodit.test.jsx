...
import NavigationBar from '../../../../../../components/features/foodit-global/common/NavigationBar/foodit.jsx';

describe('Components - Features - foodit-global - Common - NavigationBar', () => {
    beforeEach(() => {
