...
export default function ArticlesGrid() {
    ...
    const getImageLoadingProps = index => {
        if (index === 0) return { fetchPriority: 'high', loading: 'eager' };
        if (index <= 2) return { fetchPriority: 'auto', loading: 'eager' };
        return { fetchPriority: 'low', loading: 'lazy' };
    };
