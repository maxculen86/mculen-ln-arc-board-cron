...
class Carousell extends PureComponent {
    ...
    render() {
        return (
            <CarousellComponent>
                {this.props.slider.hasPrevPage() && <CarousellPrevButton onClick={this.props.slider.prevButtonHandler}/> }
                {this.props.children}
                {this.props.slider.hasNextPage() && <CarousellNextButton onClick={this.props.slider.nextButtonHandler}/> }
            </CarousellComponent>
        )
    }
}
