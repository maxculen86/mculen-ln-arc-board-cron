    ...
    return (
        <div
            ...
            dangerouslySetInnerHTML={{
                __html: `<script id="marfeelScript">${marfeelScript}</script>`
            }}
        />
    );
};
