...
class SpecialVideo extends Component {
    constructor(props) {
        super(props);
        this.videoIdsCustomFields = getSpecialVideoCustomFields(MAX_VIDEOS_COUNT, this.props)
...
function getCustomFields() {
    const SpecialVideoCustomFields = buildSpecialVideoCustomFields(MAX_VIDEOS_COUNT);
