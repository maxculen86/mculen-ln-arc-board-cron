...
import trasformBookmarkContent from '../../private/common/utils/bookmark/trasformBookmarkContent';
    ...
    return (
        <div id={featureId} htmlOnly persistent>
            <section className="bookmark">
                ...
                <BookmarkLayout data={trasformBookmarkContent(data)} />
            </section>
        </div>
    );
};
