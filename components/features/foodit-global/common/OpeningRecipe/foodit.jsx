...
export const OpeningRecipe = ({ article = {} }) => {
    ...
    return (
        <>
            <Recipe>
                <Recipe.Media>
                    {/* TODO: Add validations to render an Image or a Video (ClassName for Video container: 'w-100 ratio-16-9') */}
                    <Image
                    ...
                    <div className="flex flex-column ai-start gap-12">
                        ...
                        <div className="flex flex-column ai-start gap-16">
                            <Text
                                ...
                                text={'TITULO: ' + get(headlines, 'basic', '')}
                                as="h1"
                            />
            ...
            <div>
                <Text
                    text={'BAJADA: ' + get(subheadlines, 'basic', '')}
                    as="h2"
                />
