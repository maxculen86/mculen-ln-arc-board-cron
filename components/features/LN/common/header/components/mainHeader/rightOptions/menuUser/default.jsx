...
function MenuUser() {
    ...
    return (
        <div className="max-lg:hidden flex h-40">
            <Popper placement="bottom" triggerOn="hover" hoverDelay={100}>
                <Popper.Trigger className="flex items-center gap-8 cursor-pointer">
                    <Avatar />
                </Popper.Trigger>
                <Popper.Content className="bg-base-foreground shadow-center w-full rounded-4 p-12 text-14">
                    <div
                        className="absolute bg-base-foreground w-8 h-8 rotate-45 -top-4 left-1/2 -translate-x-1/2"
                        aria-hidden="true"
                    />
                    <nav>
                    ...
                    <Link
                        className="hover:bg-[#e7f0ff] rounded-4 p-12 w-full"
                        color="error"
                        weight="regular"
