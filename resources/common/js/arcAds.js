    ...
    return (function(e) {
        ...
        function(e, n, i) {
            ...
            Object.defineProperty(n, '__esModule', { value: !0 }),
                ...
                (n.queueGoogletagCommand = function(e) {
                    window.googletag.cmd.push(e);
                }),
                (n.setTargeting = function(e, n) {
                    for (var i in n)
                        n.hasOwnProperty(i) && n[i] && e.setTargeting(i, n[i]);
                }),
                (n.dfpSettings = function(e) {
                ...
                (n.determineSlotName = function(e, n) {
                    var i = (0, r.expandQueryString)('adslot');
                    if (i && ('' !== i || null !== i)) return '/' + e + '/' + i;
                    return '/' + e + '/' + n;
                });
            var t = i(8),
                r = i(9),
        ...
        function(e, n) {
            var i = Object.create(null),
                t = function(e, n) {
                    return e ? i[e] || (i[e] = t.ext(t.new(e, n))) : i;
                };
            (t.levels = {
                error: 1,
                warn: 2,
                ...
                (t.log = function(e, n) {
                    var r = n.length > 1 && t.levels[n[0]] ? n.shift() : 'log';
                    i[e][r].apply(i[e], n);
                }),
                (t.ext = function(e) {
                    for (var n in ((e.enabledFor = function() {}), t.levels))
                        e[n] = function() {};
                    return e;
                }),
                (e.exports = t);
        ...
        function(e, n, i) {
            'use strict';
            Object.defineProperty(n, '__esModule', { value: !0 }),
                (n.initializeBiddingServices = d),
                (n.fetchBids = function(e) {
                    var n = this,
                        i = e.ad,
                        a = e.id,
                        s = e.slotName,
                        ...
                        v = new Promise(function(e) {
                            if (u.prebid && u.prebid.enabled) {
                                var r = u.prebid.timeout || 700;
                                t.queuePrebidCommand.bind(
                                    n,
                                    (0, t.fetchPrebidBids)(
                                        i,
                                        u.prebid.useSlotForAdUnit ? s : a,
                                        r,
                                        h,
                                        f,
                                        function() {
                    ...
                    window.arcBiddingReady
                        ? Promise.all([v, w]).then(function() {
                              (0,
                              o.refreshSlot)({ ad: i, correlator: g, prerender: f, info: h });
                          })
                        : setTimeout(function() {
                              return d();
                          }, 200);
            ...
            function d(e) {
                ...
                if (window.arcBiddingReady)
                    ...
                    var d = new Promise(function(e) {
                            ...
                            } else (0, a.sendLog)('initializeBiddingServices()', 'Prebid is not enabled on this wrapper.', null), e('Prebid is not enabled on the wrapper...');
                        }),
                        s = new Promise(function(e) {
                            o && o.enabled && window.apstag
                                ? o.id && '' !== o.id
                                    ? (0, r.queueAmazonCommand)(function() {
                                          window.apstag.init({
                                              pubID: o.id,
                                              adServer: 'googletag'
                                          }),
                                              e(
                                                  'Amazon scripts have been added onto the page!'
                                              );
                                      })
                                    : (console.warn(
                                      ...
                                      e(
                                          'Amazon is not enabled on the wrapper...'
                                      ))
                                : e('Amazon is not enabled on the wrapper...');
                        });
        ...
        function(e, n, i) {
            ...
            (n.queuePrebidCommand = function(e) {
                pbjs.que.push(e);
            }),
                (n.fetchPrebidBidsArray = o),
                (n.fetchPrebidBids = function(e, n, i, t, r) {
                    var a =
                            arguments.length > 5 && void 0 !== arguments[5]
                                ? arguments[5]
                                : null,
                        d = t;
                    (d.bids = Array.isArray(t.bids) ? t.bids : [t.bids]),
                        o(e, [n], i, d, r, a);
                }),
                (n.addUnit = function(e, n, i) {
                    var r =
                    ...
                    var d = r.sizeConfig,
                        s = r.config;
                    if ((pbjs.addAdUnits(a), s)) return void pbjs.setConfig(s);
                    d && pbjs.setConfig({ sizeConfig: d });
                });
            var r = i(1);
            function o(e, n, i, t, o) {
                var a =
                    arguments.length > 5 && void 0 !== arguments[5]
                        ? arguments[5]
                        : null;
            ...
            n.ArcAds = (function() {
                function e(n) {
                    ...
                    !(function(e, n) {
                        ...
                        (this.dfpId = n.dfp.id || ''),
                        (this.wrapper = n.bidding || {}),
                        (this.positions = []),
                        (this.collapseEmptyDivs = n.dfp.collapseEmptyDivs),
                        (this.adsList = []),
                        (window.isMobile = r.MobileDetection),
                        '' === this.dfpId
                            ? (console.warn(
                            ...
                            : ((0, d.initializeGPT)(),
                              (0, d.queueGoogletagCommand)(
                                  d.dfpSettings.bind(this, i)
                              ),
                              (0, a.initializeBiddingServices)(this.wrapper));
                }
                return (
                    t(
                        e,
                        [
                                ...
                                value: function(e) {
                                    ...
                                    try {
                                        if (
                                            ...
                                            var P = this.positions[a] + 1 || 1;
                                            this.positions[a] = P;
                                            var z = Object.assign(c, {
                                                position: P
                                            });
                                            Object.assign(e, { targeting: z });
                                        }
                                        var S =
                                            b.prebid &&
                                            ((b.prebid.enabled &&
                                                b.prebid.bids) ||
                                                (void 0 === b.prebid.enabled &&
                                                    b.prebid.bids));
                                        if (
                                            (isMobile.any() &&
                                                'mobile' === g) ||
                                            ...
                                            if (
                                                ...
                                                var L = this.wrapper.prebid
                                                    .useSlotForAdUnit
                                                    ? (0, d.determineSlotName)(
                                                          this.dfpId,
                                                          i
                                                      )
                                                    : n;
                                                s.queuePrebidCommand.bind(
                                                    this,
                                                    (0, s.addUnit)(
                                                        L,
                                                        y,
                            ...
                            },
                            {
                                ...
                                value: function(e) {
                                    ...
                                    if (u && u.breakpoints && t) {
                                        var w = (0, l.prepareSizeMaps)(
                                                h,
                                                u.breakpoints
                                            ),
                                            m = w.mapping,
                                    ...
                                    v &&
                                        ...
                                        (0, d.setTargeting)(v, r));
                                    var k =
                                        u && u.breakpoints ? u.breakpoints : [];
                                ...
                                value: function() {
                                    ...
                                    googletag.pubadsReady
                                        ? (window.googletag
                                          ...
                                          this.registerAdCollectionSingleCall(
                                              this.adsList,
                                              n
                                          ))
                                        : setTimeout(function() {
                            ...
                            },
                            {
                                key: 'reserveAd',
                                value: function(n) {
                                    e.setAdsBlockGate(), this.adsList.push(n);
                                }
                            },
                            {
        ...
        function(e, n, i) {
            ...
            var r = (n.MobileDetection = (function() {
                function e() {
                    !(function(e, n) {
                        if (!(e instanceof n))
                            throw new TypeError(
        ...
        function(e, n, i) {
            ...
            t.default.ext = function(e) {
                ...
                for (var i in t.default.levels)
                    e[i] = (n && (n[i] || n.log)) || function() {};
                return (
        ...
        function(e, n, i) {
            'use strict';
            Object.defineProperty(n, '__esModule', { value: !0 }),
                (n.appendResource = function(e, n, i, t, r) {
                    var o = document.createElement(e);
                    if ('script' !== e) return;
                    (o.src = n), (o.async = i || !1), (o.defer = i || t || !1);
        ...
        function(e, n, i) {
            'use strict';
            Object.defineProperty(n, '__esModule', { value: !0 }),
                (n.expandQueryString = function(e) {
        ...
        function(e, n, i) {
            ...
            Object.defineProperty(n, '__esModule', { value: !0 }),
                (n.fetchAmazonBids = function(e, n, i, r) {
                    var o =
                            arguments.length > 4 && void 0 !== arguments[4]
                                ? arguments[4]
                                : null,
                ...
                (n.queueAmazonCommand = t);
        },
        function(e, n, i) {
            'use strict';
            Object.defineProperty(n, '__esModule', { value: !0 }),
                (n.resizeListeners = n.sizemapListeners = void 0),
                (n.prepareSizeMaps = function(e, n) {
                    var i = [],
                        t = [],
                        r = [],
                        o = n.length ? n : null;
                    ...
                    return (
                        ...
                        { mapping: i, breakpoints: t, correlators: r }
                    );
                }),
                (n.parseSizeMappings = l),
                (n.runResizeEvents = u),
                (n.setResizeListener = function(e) {
                    var n = e.id,
                        i = e.correlators;
                    (s[n] = (0, t.debounce)(u(e), 250)),
                        window.addEventListener('resize', s[n]),
                        (d[n] = { listener: s[n], correlators: i });
                });
            var t = i(12),
                r = i(3),
                o = i(1),
                a = i(0),
                d = (n.sizemapListeners = {}),
                s = (n.resizeListeners = {});
            function l(e) {
                try {
                    var n = [
                        ...
                        t = i.length > 0 ? i[0][1] : [];
                    return (
                        t.length > 0 && t[0].constructor !== Array && (t = [t]),
                        t
                    );
                } catch (n) {
                    return (
