...
var searchPage = {
    ...
    resultcallback: function (results) {
        ...
        html = html + '<div class="flex jc-between"><div class="text-24 text-28_md prumo prumo-light text-light-800" id="results_count"><span class="prumo prumo-medium">' + results.metadata.total + '</span> resultados de: ' + (results.metadata.query.trim().toLowerCase() == 'Saladas' ? "" :  results.metadata.query.trim()) + '</div><div class="lg-none w-40 h-40"></div></div>';
