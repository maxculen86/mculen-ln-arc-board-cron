// Migrated from: components/layouts/Foodit-subcategorias/foodit.jsx
// Migration date: 2026-06-29
// Strategy: faithful copy — kept in parity with the monolith; /recetas keeps this layout (no swap).
