    ...
    return (
        <html lang="es">
            ...
            <body>
                ...
                {/* navigationTreeSource: NO necesario para MX
                (docs/migrate-mx/content-sources/audit.md §5). Sin otro consumidor en
                apps/foodit-mx — TagsLoadingList queda deshabilitado a propósito. */}
                {/* <TagsLoadingList
                    section={_nodeType}
                    location="body-top"
                    arcSite={arcSite}
